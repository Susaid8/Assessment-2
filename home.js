...
console.log(canWeDeliver(55421)) 
...
console.log(canWeDeliverTwo(55421))
...
const dealDown = deals.replace('15', '10')
...
const deals = 'Free Kids Meal with 2 Regular Entrees. This deal lasts until the end of March! '

const familyDeal = deals.replace('March', 'April')
console.log(familyDeal.trim())
